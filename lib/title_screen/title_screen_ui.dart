  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Stack(
        children: [
          /// Title Text
          const TopLeft(child: UiScaler(alignment: Alignment.topLeft, child: _TitleText())),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        ).animate().fadeIn(delay: 1.3.seconds, duration: .35.seconds).slide(begin: const Offset(0, .2)),
        _DifficultyBtn(
          label: 'Normal',
        ...
        ).animate().fadeIn(delay: 1.7.seconds, duration: .35.seconds).slide(begin: const Offset(0, .2)),
        const Gap(20),
      ],
    );
  }
...
class _DifficultyBtn extends StatelessWidget {
  const _DifficultyBtn({required this.selected, required this.onPressed, required this.onHover, required this.label});
  final String label;
  final bool selected;
            ...
            child: Stack(
              children: [
                ...
                if (state.isHovered || state.isFocused) ...[
                  Container(decoration: BoxDecoration(color: const Color(0xFF00D1FF).withAlpha(25))),
                ],
            ...
            children: [
              ...
              Center(
                child: Row(
                  ...
                  children: [Text('START MISSION', style: TextStyles.btn.copyWith(fontSize: 24, letterSpacing: 18))],
                ),
              ),
            ],
